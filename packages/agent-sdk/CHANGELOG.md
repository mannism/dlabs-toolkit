...
- Updated dependencies [092cf11]
  - @diabolicallabs/llm-client@6.9.0

## 3.3.4

### Patch Changes

- Updated dependencies [48a8b93]
  - @diabolicallabs/llm-client@6.8.0

## 3.3.3

### Patch Changes

- Updated dependencies [83d1398]
  - @diabolicallabs/llm-client@6.7.0

## 3.3.2

### Patch Changes

- Updated dependencies [a0684bf]
  - @diabolicallabs/llm-client@6.6.0

## 3.3.1

### Patch Changes

- Updated dependencies [9740b63]
  - @diabolicallabs/llm-client@6.5.1

## 3.3.0

### Minor Changes

- 4d1e422: Add `CallRecord.provider`, an optional `LlmProvider` field always populated from the wrapped `LlmClient`'s `config.provider` — a required, `readonly`-enforced, construction-time-invariant field on the client, not inferred from the model string. `buildAfterCallDispatch()` now takes a `provider` parameter bound once per `instrumentClient()` call, and `buildCallRecord()`'s seven positional parameters have been converted to a single options object (both are module-private, so this is not a public API change).
...
- Updated dependencies [69b86f0]
  - @diabolicallabs/llm-client@6.5.0

## 3.2.9

### Patch Changes

- Updated dependencies [0dfdf88]
  - @diabolicallabs/llm-client@6.4.0

## 3.2.8

### Patch Changes

- Updated dependencies [ecf5bb2]
  - @diabolicallabs/llm-client@6.3.0

## 3.2.7

### Patch Changes

- Updated dependencies [e26fe8a]
  - @diabolicallabs/llm-client@6.2.0
...
- @diabolicallabs/llm-client@6.0.0

## 3.2.4

### Patch Changes

- Updated dependencies [a9f343a]
  - @diabolicallabs/llm-client@5.2.0

## 3.2.3

### Patch Changes

- 3cad453: feat(llm-client): Files API — video and large-file inputs (v5.1.0)
  ...
  **Provider support:**
  ...
  - **Gemini** — full: video/_/image/_/PDF upload, async state poll (PROCESSING → ACTIVE), fileData parts in messages
...
- Updated dependencies [3cad453]
  - @diabolicallabs/llm-client@5.1.0

## 3.2.2

### Patch Changes

- Updated dependencies [d4607c2]
  - @diabolicallabs/llm-client@5.0.0

## 3.2.1

### Patch Changes

- Updated dependencies [3a50090]
  - @diabolicallabs/llm-client@4.2.0

## 3.2.0

### Minor Changes

- 7f80293: `instrumentClient()` now validates `identity.agentId` and `identity.projectId` as RFC 4122 UUIDs at call time — invalid values emit a `console.warn` naming the malformed field(s) and flip the client to no-op mode instead of silently dispatching records that the dashboard rejects.

## 3.1.0

### Minor Changes

- 46a18a3: Add pluggable `AgentSdkLogger` with stdout JSON default.
...
- Updated dependencies [c453127]
  - @diabolicallabs/llm-client@4.1.0

## 3.0.5

### Patch Changes

- @diabolicallabs/llm-client@4.0.0
...
- Updated dependencies [7ac1d59]
  - @diabolicallabs/llm-client@3.0.1

## 3.0.3

### Patch Changes

- @diabolicallabs/llm-client@3.0.0

## 3.0.2

### Patch Changes

- @diabolicallabs/llm-client@2.0.0

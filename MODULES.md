...
|---|---|---|---|
| `@diabolicallabs/llm-client` | scaffolded | [`packages/llm-client/manifest.yaml`](packages/llm-client/manifest.yaml) | Unified LLM API — Anthropic, OpenAI, Google, DeepSeek. Streaming, retry, structured output, token normalisation. |

...
|---|---|---|---|
| `@diabolicallabs/llm-client` | in-progress | [`packages/llm-client/manifest.yaml`](packages/llm-client/manifest.yaml) | Unified LLM API — Anthropic, OpenAI, Gemini, DeepSeek (impl); Perplexity (stub). Streaming, retry, structured output, token normalisation. |
